  ...
  return (
    <div className="min-h-screen bg-[#0d1117] text-white w-full">
      ...
      <div className="flex flex-col lg:flex-row w-full min-h-screen">
        ...
        {/* === 1. SIDEBAR (Largura Fixa no Desktop) === */}
        {/* Mudança: lg:w-[400px] xl:w-[450px] fixa a largura, evitando gaps */}
        <div className="lg:w-[400px] xl:w-[450px] flex-shrink-0 p-8 lg:p-10 lg:h-screen lg:sticky lg:top-0 bg-[#161b22] border-r border-gray-800 flex flex-col overflow-y-auto scrollbar-hide z-20 shadow-2xl">
          ...
          >
            ...
            <div className="mt-auto pt-6 border-t border-gray-700 flex flex-col gap-3">
               {project.github && (
                 <a href={project.github} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 p-3 bg-white text-black hover:bg-gray-200 rounded-lg transition-all font-bold text-sm">
                   <FaGithub size={18} /> Ver Código Fonte
                 </a>
               )}
               {project.demo && (
                 <a href={project.demo} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 p-3 bg-blue-600 hover:bg-blue-500 text-white rounded-lg transition-all font-bold text-sm shadow-lg shadow-blue-900/20">
        ...
        {/* === 2. GALERIA (Ocupa todo o resto) === */}
        {/* Mudança: flex-1 garante que ocupe todo o espaço restante sem sobras */}
           ...
           <div className="p-4 md:p-12 max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-1 gap-12">
                 {project.images && project.images.map((img, idx) => (
                   ...
                   >
                      {/* Barra de título da janela (Estética) */}
                 ...
                 {(!project.images || project.images.length === 0) && (
                    <div className="h-64 flex flex-col items-center justify-center border border-dashed border-gray-800 rounded-xl text-gray-600 bg-[#161b22]/50">
                       <FaImages size={30} className="mb-4 opacity-50"/>
                       <p>Galeria indisponível para este projeto.</p>
                    </div>
                 )}
              </div>
           </div>
